...
; -----------------------------------------
; Last updated: 18-DEC-2004    Version 1.32
; -----------------------------------------
...
;  
;   ROM routines do all the housekeeping. This is the same code the I used
...
;                               bug reports.
;                               Also the abbreviation suggestion.
