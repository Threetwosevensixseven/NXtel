CREATE DATABASE  IF NOT EXISTS `nxtel` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `nxtel`;
...
CREATE TABLE `notice` (
  ...
  KEY `FK_notice_page_idx` (`PageID`),
  CONSTRAINT `FK_notice_page` FOREIGN KEY (`PageID`) REFERENCES `page` (`PageID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `noticeread`
--
...
CREATE TABLE `noticeread` (
  ...
  KEY `FK_noticeread_notice_idx` (`NoticeID`),
  KEY `FK_noticeread_user_idx` (`UserNo`),
  CONSTRAINT `FK_noticeread_notice` FOREIGN KEY (`NoticeID`) REFERENCES `notice` (`NoticeID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_noticeread_user` FOREIGN KEY (`UserNo`) REFERENCES `aspnetusers` (`UserNo`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `page` (
  ...
  `IsCarousel` bit(1) DEFAULT NULL,
  `CarouselWait` int(10) DEFAULT NULL,
  ...
  KEY `FK_page_UpdatedBy_idx` (`UpdatedBy`),
  CONSTRAINT `FK_page_OwnerID` FOREIGN KEY (`OwnerID`) REFERENCES `aspnetusers` (`UserNo`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_page_UpdatedBy` FOREIGN KEY (`UpdatedBy`) REFERENCES `aspnetusers` (`UserNo`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `stats` (
  ...
  `FrameNo` int(11) NOT NULL,
  PRIMARY KEY (`StatsID`),
  KEY `ix_stats_PageNo` (`PageNo`)
) ENGINE=InnoDB AUTO_INCREMENT=13143 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-03-20 13:37:11
