...
namespace HeyRed.MarkdownSharp
{
    ...
    public class Markdown
    {
        ...
        {
            get { return _options.Strikethrough; }
            set { _options.Strikethrough = value; }
        }
        ...
        private static Regex _strikethrough = new Regex(@"(~)(.*?)(~)",
            RegexOptions.Singleline | RegexOptions.Compiled);

        /// <summary>
        /// Turn Markdown ~skrikethrough~ into HTML del tags
        /// </summary>
